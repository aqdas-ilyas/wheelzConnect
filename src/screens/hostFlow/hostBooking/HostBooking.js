...
export default HostingBook = (props) => {
    ...
    return (
      <FlatList
        ...
        renderItem={({ item, index }) => {
          return (
            <CarList item={item} key={index} navigation={props.navigation} onpress={() => props.navigation.navigate(routes.ReservedCarDetail, { key: 'reserved' })} />
          )
        }}
      />
    );
  ...
  const Handovered = () => {
    return (
      <FlatList
        ...
        renderItem={({ item, index }) => {
          return (
            <CarList item={item} key={index} navigation={props.navigation} onpress={() => props.navigation.navigate(routes.ReservedCarDetail, { key: 'handOver' })} />
          )
        }}
      />
    );
